...
class NewForm: FormViewController {
...
//    let 👦🏼 = "👦🏼", 🍐 = "🍐", 💁🏻 = "💁🏻", 🐗 = "🐗", 🐼 = "🐼", 🐻 = "🐻", 🐖 = "🐖", 🐡 = "🐡"
    ...
    func createForm() {
        ...
        +++ Section("Ad Details"){
            $0.tag = "Your ad"
            $0.hidden = "$segments != 'Billboard'" // .Predicate(NSPredicate(format: "$segments != 'Sport'"))
        }
    ...
    +++ Section(){
        $0.tag = "Catalog"
        $0.hidden = "$segments != 'Map Pin'" // .Predicate(NSPredicate(format: "$segments != 'Sport'"))
    }
    ...
    +++ Section(){
        $0.tag = "Customer"
        $0.hidden = "$segments != 'Map Pin'"
        
    }
    <<< MultipleSelectorRow<String>("Choose your devices!") {
        $0.title = $0.tag
        $0.options = ["iPhone6", "iPhone7","iPhone10", "iPhone4", "iPhone11","iPhone12"]
        $0.value = ["iPhone6", "iPhone7","iPhone10"]
    }
    
    .onPresent { from, to in
        //            to.sectionKeyForValue = { option in
        //                switch option {
        //                    case "iPhone6", "iPhone7": return "Hello"
        //                    case "iPhone4", "iPhone10": return "2 or more"
        //                    default: return ""
        //                }
        //            }
    ...
    <<< MultipleSelectorRow<String>("Ethnicity") {
        $0.title = "Ethnicity"
        $0.options = ["Caucasian", "African American","Hispanic", "Alaskan", "Canadian","Arabic"]
        //            $0.value = [""]
        //            if $0.cell.words == "Caucasian" {
        //                $0.value = ["Changed"]
        //            }
    }
    ...
    <<< SegmentedRow<String>(){
        $0.title = "Gender"
        $0.options = ["Male", "Female", "Other", "All"]
    }.cellSetup { cell, row in
        cell.segmentedControl.backgroundColor = .green
