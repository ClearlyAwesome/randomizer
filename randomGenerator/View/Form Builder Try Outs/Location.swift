...
public class MapViewController : UIViewController, TypedRowControllerType, MKMapViewDelegate {
    ...
    lazy var pinView: UIImageView = { [unowned self] in
        ...
        v.image = UIImage(named: "cat", in: Bundle(for: MapViewController.self), compatibleWith: nil)
    ...
    func updateTitle(){
        ...
        let latitude2 = NSNumber(value: mapView.centerCoordinate.latitude)
        let longitude2 = NSNumber(value: mapView.centerCoordinate.longitude)
            
        let geo = CLGeocoder()
        geo.reverseGeocodeLocation(CLLocation(latitude: CLLocationDegrees(latitude2), longitude: CLLocationDegrees(longitude2))) { placemark, error in
